      ...
      <div className="relative z-10 container mx-auto px-6 h-full min-h-[90vh] flex items-center">
        <div className="max-w-2xl py-24 md:py-32">
          <h1 className="reveal-on-scroll text-[2.4rem] sm:text-[3.2rem] md:text-[4rem] lg:text-[4.8rem] tracking-[-0.04em] leading-[1.02] mb-8">
            <span className="font-extralight text-primary-foreground/60">Orijinal TV parçaları,</span>
            <br />
            <span className="font-black text-primary-foreground">güvenilir tedarikçiniz.</span>
          </h1>

          <p className="reveal-on-scroll delay-1 text-[15px] md:text-[17px] text-primary-foreground/70 max-w-lg mb-10 leading-[1.7]">
            Samsung, LG, Vestel ve daha fazlası için orijinal yedek parça ve anakart tedariki.
