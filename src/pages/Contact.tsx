  ...
  const contactCards = [
    {
      ...
      link: siteConfig.contact.mapsUrl,
      linkText: "Haritada Aç →",
    },
    {
      icon: Phone,
      title: "Telefon",
      content: siteConfig.contact.phone,
      link: siteConfig.contact.phoneHref,
    },
    {
      icon: Mail,
      title: "E-posta",
        ...
        <div className="relative container mx-auto px-6 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <p className="text-sm text-primary-foreground/50 mt-4 max-w-md leading-relaxed">
              Sorularınız, teknik destek talepleriniz veya sipariş bilgisi için bize ulaşın. En kısa sürede dönüş yapacağız.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div ref={formRef}>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="reveal-on-scroll delay-1 bg-card rounded-2xl border border-border p-8 space-y-5" noValidate>
                ...
                <div className="flex items-start gap-3">
                  <Checkbox
                    id="kvkk"
                    checked={kvkkChecked === true}
                    onCheckedChange={(checked) => setValue("kvkk", checked === true ? true : false as any)}
                    className="mt-0.5"
                  />
            ...
            <div ref={mapRef}>
              ...
              <div className="reveal-on-scroll delay-1 rounded-2xl overflow-hidden border border-border aspect-[4/3] lg:aspect-auto lg:h-[calc(100%-3.5rem)]">
                <iframe
                  title="Garanti Elektronik Konum"
