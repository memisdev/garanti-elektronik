      ...
      <section className="bg-foreground relative overflow-hidden">
        <div className="relative container mx-auto px-6 py-20 md:py-28">
          ...
          <p className="text-sm text-primary-foreground/50 mt-4 max-w-md leading-relaxed">
            Müşteri memnuniyeti odaklı garanti ve iade politikamız hakkında detaylı bilgi.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 max-w-3xl">
          <div className="space-y-8">
            {sections.map((section, i) => (
              <div
                key={section.title}
                className={`reveal-on-scroll delay-${Math.min(i + 1, 4)} bg-card rounded-2xl border border-border p-8`}
              >
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 rounded-xl bg-foreground flex items-center justify-center">
                    <section.icon className="w-4.5 h-4.5 text-primary-foreground" aria-hidden="true" />
                  </div>
